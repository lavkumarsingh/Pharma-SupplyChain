...
import {Box, Button, Card, Checkbox, Flex, Heading, Icon, Input, OutlineButton, Text, Textarea} from 'rimble-ui'
...
function App() {
    ...
    //states
    if (isLoading) {
        return <div className='centered-Loader'><Spinner style={{width: '10rem', height: '10rem'}} type="grow"
                                                         color="danger"/></div>
    } else {
        return (
            <div>

                <h1 className="display-1" style={{marginLeft: '80px'}}><span role="img" aria-label='stars'> 💊💉 </span>Pharma~Chain
                </h1>
                        ...
                        <Box m={5} p={10}>
                            <Flex style={{justifyContent: 'center'}}>
                                {roles.map(role => (
                                    <Box key={role.id} Flex>
                                        ...
                                        <Button key={role.id} p={3} m={1}
                                                onClick={() => addMeTo(role.role)}>Assign {role.role}</Button>
                                        <Button key={role.id} p={3} m={1}
                                                onClick={() => removeMeFrom(role.role)}>Remove {role.role}</Button>
                                    </Box>
                                ))}
                            </Flex>
                            <Flex style={{justifyContent: 'center'}} m={10} p={20}>
                                <Button p={3} m={1} Flex size='large' onClick={() => currentAccountRoles()}>Who Am I
                                    ??</Button>
                            </Flex>
                            ...
                            <Flex style={{justifyContent: 'center'}}>
                                <Card width={[1, 1, 1 / 4]} Flex>
                                    ...
                                    <Input type='text' p={3} m={1} placeholder='new regulator address'
                        ...
                        <Box m={10} p={20}>
                            <Flex>
                                <Card width={[1, 1, 1 / 3]} mx={'auto'} px={3} pt={20} Flex>
                                    ...
                                    <Textarea rows='2' width={[1, 1, 1]} p={3} m={1} placeholder='Description'
                                              name='drugDesignDesc'/>
                                    <Textarea rows='2' width={[1, 1, 1]} p={3} m={1} placeholder='Add Notes'
                                              name='drugDesignNotes'/>
                                    <OutlineButton p={3} m={1} onClick={() => addDrugDesign()}>Add Drug
                                        Design</OutlineButton>
                                </Card>
                                <Card width={[1, 1, 1 / 3]} mx={'auto'} px={3} pt={20} Flex>
                                    <Heading>Add Drug Test</Heading>
                                    <Text color='red' px={20}>only regulator or the owner</Text>
                                    <Input type='text' p={3} m={1} placeholder='Drug design Sn.' name='drugTestUDPC'/>
                                    <Textarea rows='2' width={[1, 1, 1]} p={3} m={1} placeholder='Description'
                                              name='drugTestDesc'/>
                                    ...
                                    <Textarea rows='2' width={[1, 1, 1]} p={3} m={1} placeholder='Add Notes'
                                              name='drugTestNotes'/>
                                    <Flex>
                                        <OutlineButton p={3} m={1} onClick={() => {
                                            addDrugTest()
                                        }}>Add Test by owner</OutlineButton>
                                        <OutlineButton p={3} m={1} onClick={() => {
                                            addDrugTestByRegulator()
                                        }}>Add Test by Regulator</OutlineButton>
                                    </Flex>
                            ...
                            <Flex>
                                <Card width={[1, 1, 1 / 4]} mx={'auto'} px={3} pt={20} Flex>
                                    ...
                                    <Text color='red' px={20}>only regulator</Text>
                                    <Input type='text' p={3} m={1} placeholder='Drug design Sn.'
                                           name='drugApproveUDPC'/>
                                    <p/>
                                    <OutlineButton pt={3} mt={1} onClick={() => {
                                        approveDrug()
                                    }}>Approve </OutlineButton>
                                </Card>
                                <Card width={[1, 1, 1 / 4]} mx={'auto'} px={3} pt={20} Flex>
                                    <Heading>Sell Drug Design</Heading>
                                    <Text color='red' px={20}>only owner of drug design</Text>
                                    <Input type='text' p={3} m={1} placeholder='Drug design Sn.' name='sellDrugUDPC'/>
                                    <Input type='text' p={3} m={1} placeholder='Ether Price' name='sellDrugPrice'/>
                                    <p/>
                                    <OutlineButton p={3} m={1} onClick={() => {
                                        sellDrugDesign()
                                    }}>Up For Sell</OutlineButton>
                                </Card>
                                <Card width={[1, 1, 1 / 4]} mx={'auto'} px={3} pt={20} Flex>
                                    <Heading>Buy Drug Design</Heading>
                                    <Text color='red' px={20}>only manufacturer or designer</Text>
                                    <Input type='text' p={3} m={1} placeholder='Drug design Sn.' name='buyDrugUDPC'/>
                        ...
                        <Box m={10} p={20}>
                            <Flex>
                                ...
                                <Card width={[1, 1, 1 / 4]} mx={'auto'} px={3} pt={20} Flex>
                                    ...
                                    <Text color='red' px={20}>only manufacturer of drugs load</Text>
                                    <Input type='text' p={3} m={1} placeholder='Batch ID' name='addSLU'/>
                                    <Input type='text' p={3} m={1} placeholder='Unit Price' name='addPrice'/>
                                    <p/>
                                    <OutlineButton p={3} m={1} onClick={() => {
                                        addDrugLoad()
                                    }}>Up For Sale</OutlineButton>
                                </Card>
                            </Flex>
                            ...
                            <Flex>
                                <Card width={[1, 1, 1 / 4]} mx={'auto'} px={3} pt={20} Flex>
                                    ...
                                    <Input type='text' p={3} m={1} placeholder='Batch ID' name='buySLU'/>
                                    <Input type='text' p={3} m={1} placeholder='Retailer Address'
                                ...
                                <Card width={[1, 1, 1 / 4]} mx={'auto'} px={3} pt={20} Flex>
                                    ...
                                    <Text color='red' px={20}>only manufacturer of drugs load</Text>
                                    <Input type='text' p={3} m={1} placeholder='Batch ID' name='shipSLU'/>
                                    <p/>
                                    <OutlineButton p={3} m={1} onClick={() => {
                                        shipDrugLoad()
                                    }}>Ship</OutlineButton>
                                ...
                                <Card width={[1, 1, 1 / 4]} mx={'auto'} px={3} pt={20} Flex>
                                    ...
                                    <Input type='text' p={3} m={1} placeholder='Batch ID' name='shipEnvSLU'/>
                            ...
                            <Flex>
                                <Card width={[1, 1, 1 / 4]} mx={'auto'} px={3} pt={20} Flex>
                                    ...
                                    <Input type='text' p={3} m={1} placeholder='Batch ID' name='receiveSLU'/>
                                    <p/>
                                    <OutlineButton p={3} m={1} onClick={() => {
                                        receiveDrugLoad()
                                    }}>Recieve</OutlineButton>
                                </Card>

                                <Card width={[1, 1, 1 / 4]} mx={'auto'} px={3} pt={20} Flex>
                                    <Heading>Update Stocking Envuirment</Heading>
                                    <Text color='red' px={20}>only Retailer of drugs load</Text>
                                    <Input type='text' p={3} m={1} placeholder='Batch ID' name='stockEnvSLU'/>
                        ...
                        <Box m={10} p={20}>
                            <Flex>
                                <Card width={[1, 1, 1 / 4]} mx={'auto'} px={3} pt={20} Flex>
                                    ...
                                    <Input type='text' p={3} m={1} placeholder='Product ID' name='purchasePKU'/>
                                    <Input type='text' p={3} m={1} placeholder='Ether Value' name='purchaseValue'/>
                                    <p/>
                                    <OutlineButton p={3} m={1} onClick={() => {
                                        purchaseDrug()
                                    }}>Purchase</OutlineButton>
                                </Card>
                            </Flex>
                        </Box>
                    </TabPane>
                    ...
                    <TabPane tabId='5'>
                        <Box m={10} p={20}>
                            <Card>
                                ...
                                <Input type='text' p={3} m={1} placeholder='Drug design Sn.' name='fetchDrugUDPC'/>
                                <Button size='mediam' p={3} m={1} onClick={() => {
                                    fetchDrugDesignData()
                                }}>Fetch Data</Button>
                                <Text color='green' px={20}>see logs </Text>

                                <Heading>Batch</Heading>
                                <Input type='text' p={3} m={1} placeholder='Batch ID' name='fetchDrugSLU'/>
                                <Button size='mediam' p={3} m={1} onClick={() => {
                                    fetchDrugLoadData()
                                }}>Fetch Batch Data</Button>
                                <Button size='mediam' p={3} m={1} onClick={() => {
                                    getDrugLoadPKUs()
                                }}>Fetch Product Ids</Button>
                                <Text color='green' px={20}>see logs </Text>

                                <Heading>Products</Heading>
                                <Input type='text' p={3} m={1} placeholder='Product ID' name='fetchDrugPKU'/>
                                <Button size='mediam' p={3} m={1} onClick={() => {
                                    fetchDrugData()
                                }}>Fetch Product Data</Button>
                                <Button size='mediam' p={3} m={1} onClick={() => {
                                    fetchEnvHistory()
                                }}>Fetch Enviurment History</Button>
                                <Text color='green' px={20}>see logs </Text>
                            </Card>
                        </Box>
                    </TabPane>
